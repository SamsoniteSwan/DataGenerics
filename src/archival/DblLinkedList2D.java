...
import linkedList.DLinkedListInterface;
 ...
 */
public class DblLinkedList2D<K extends Comparable, S> implements DLinkedListInterface<K, S>, Iterable<K> {
    ...
    private DblLinkedList2D(EntryNode start, EntryNode end) {
        firstNode = start;
        lastNode = end;
    }            
    ...
    */
    ...
    private final class EntryNode<K extends Comparable<? super K>, S> implements Iterator {
        ...
        DblLinkedList2D<K, S> sublist;

        public EntryNode(K key, S value) {
            dataKey = key;
            dataVal = value;
            sublist = new DblLinkedList2D();
        }
